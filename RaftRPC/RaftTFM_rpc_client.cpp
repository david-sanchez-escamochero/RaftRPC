...
#define GENERIC_BINDING_TABLE_SIZE   0            
    ...
    static const RPC_CLIENT_INTERFACE RaftTFM___RpcClientInterface =
    {
    ...
    RPC_IF_HANDLE RaftTFM_v1_0_c_ifspec = (RPC_IF_HANDLE)&RaftTFM___RpcClientInterface;

    extern const MIDL_STUB_DESC RaftTFM_StubDesc;

    static RPC_BINDING_HANDLE RaftTFM__MIDL_AutoBindHandle;
...
/*  2 */
    ...
    {
    (void*)&RaftTFM___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &RaftTFM__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
